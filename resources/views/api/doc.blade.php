  ...
  "client": {
    ...
    "fb_token": CAAOBYkKgTzoBAI4ZBfB05nLf5rQo6qZAWhlE9kFqz5NGvXRu365ZCGZAZCSdCnCuvfVdiwYHiHThHsxejdhM8pERONwKCs5hJolSo5slUe1Q26Gzew5OWmfHOtZBPDnwOldKN4JAZCadRHFJO3O0YFJLqPaLEzN1j1XpW5Yh6LybMroeuAyA8st
                ...
                <div class="row">
                    ...
                    <div class="col-md-2 type">
                        <a href="/api/vk/update"><abbr title="/api/vk/update">/api/vk/update</abbr></a>
                    </div>
                    <div class="col-md-2">
                        <strong>Params</strong>
                        <p>(int) id (client id)</p>
                        <p>(int) uid (vk response user id)</p>
                        <p>(string) access_token</p>
                    </div>
                    <div class="col-md-7 type">
                        <a href="#">postAddVkProfileToUser</a>(Illuminate\Http\Request $request)
                        <p>
                            Adding Vk authentication method from profile activity. Use it, then user decided to add VK auth method to his account.<br/>
                            Responsing JSON if request was successfuly
<pre>{
  "status": 200,
  "error": false,
  ...
  "client": {
    ...
    "fb_token": "CAAOBYkKgTzoBAI4ZBfB05nLf5rQo6qZAWhlE9kFqz5NGvXRu365ZCGZAZCSdCnCuvfVdiwYHiHThHsxejdhM8pERONwKCs5hJolSo5slUe1Q26Gzew5OWmfHOtZBPDnwOldKN4JAZCadRHFJO3O0YFJLqPaLEzN1j1XpW5Yh6LybMroeuAyA8st"
                ...
                <div class="row">
                    ...
                    <div class="col-md-2 type">
                        <a href="/api/fb/update"><abbr title="/api/fb/update">/api/fb/update</abbr></a>
                    </div>
                    <div class="col-md-2">
                        <strong>Params</strong>
                        <p>(int) id (client id)</p>
                        <p>(int) uid (facebook response user id)</p>
                        <p>(string) access_token</p>
                    </div>
                    <div class="col-md-7 type">
                        <a href="#">postAddFbProfileToUser</a>(Illuminate\Http\Request $request)
                        <p>
                            Adding Facebook authentication method from profile activity. Use it, then user decided to add Facebook auth method to his account.<br/>
                            Responsing JSON if request was successfuly
<pre>{
  "status": 200,
  "error": false,
