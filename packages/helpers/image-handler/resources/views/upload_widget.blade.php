<div class="row">
    <div class="col-md-offset-1 col-md-10">
        ...
        <form action="{{action('\Helpers\ImageHandler\ImageHandlerController@postUpload')}}" enctype="multipart/form-data" id="image-dropzone" class="uploadform dropzone no-margin dz-clickable">
            ...
            <h4 style="text-align: center;color:#428bca;">Перетащите картинки сюда, которые вы хотите приложить к данной работе<span class="glyphicon glyphicon-hand-down"></span></h4>

        </form>
        <p class="small">Максимально допустимый размер файлов 8мб</p>
    </div>
</div>
...
<div id="preview-template" style="display: none;">
    ...
    <div class="dz-preview dz-file-preview dz-main-checker">
