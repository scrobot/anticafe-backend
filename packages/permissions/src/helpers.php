...
if(!function_exists('can')) {
    ...
    {
        return \Anticafe\Packages\Permissions\Permiter::checkPermission($permission, $operator, false, $user, $callback);
    }
}
...
if(!function_exists('check_perm')) {
    ...
    {
        return \Anticafe\Packages\Permissions\Permiter::checkPermission($permission, $operator, true, $user, $callback);
    }
}
